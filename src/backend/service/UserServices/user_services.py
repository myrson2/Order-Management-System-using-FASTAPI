...
class MerchantService:
    ...
    def _load_merchant_cache(self) -> None:
        ...
        """
        for customer_data in self.merchant_repo.load_repo():
            self.merchant_cache.append(customer_data)
    ...
    def save_merchant_cache(self) -> None:
        ...
        """
        json_data = [customer for customer in self.merchant_cache]
    ...
    def add_merchant(self, customer_data: dict) -> None:
        """
        Description / Purpose:
